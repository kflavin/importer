...
class CloudWatchLogHandler(logging.Handler):
    ...
    @staticmethod
    def _get_session(boto3_session, boto3_profile_name, region):
        if boto3_session:
    ...
    def __init__(self, log_group=__name__, stream_name=None, use_queues=True, send_interval=60,
                 ...
                 boto3_profile_name=None, create_log_group=True, region=None, *args, **kwargs):
        ...
        if region:
            self.cwl_client = boto3.client('logs', region_name=region)
        else:
