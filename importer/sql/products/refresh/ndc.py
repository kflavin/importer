...
INSERT INTO {target_table_name} (labelername, productndc, proprietaryname, nonproprietaryname, producttypename, marketingcategoryname, ndc_exclude_flag, drug_id, ind_drug_name, ind_name, status, phase, ind_detailedstatus)
...
INSERT INTO {target_table_name2} (master_id, labelername, productndc, proprietaryname, nonproprietaryname, producttypename, marketingcategoryname, definition, te_code, type, interpretation, ndc_exclude_flag, drug_id, ind_drug_name, ind_name, status, phase, ind_detailedstatus, eff_date, end_eff_date)
